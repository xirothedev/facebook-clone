...
export class NotificationsService {
	...
	async create(createNotificationDto: CreateNotificationDto) {
		try {
			...
			const notification =
				await this.notificationGroupingService.createNotificationWithGrouping(createNotificationDto);
			...
			if (isSubscribed) {
				...
				this.logger.log(
					`User ${notification.recipientId} is ${!isSubscribed ? "subscribed" : "not subscribed"}, notification stored for later delivery`,
				);
			}
