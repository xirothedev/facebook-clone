...
h.logarithm = h.log = function (e) {
	...
	if (
		...
		do
			if (((u += 10), (o = B(this, u)), (t = n ? ue(l, u + 10) : B(e, u)), (c = k(o, t, u, 1)), !s)) {
...
h.minus = h.sub = function (e) {
	...
	if (((e = new v(e)), !this.d || !e.d))
		return (!this.s || !e.s ? (e = new v(NaN)) : this.d ? (e.s = -e.s) : (e = new v(e.d || this.s !== e.s ? this : NaN)), e);
...
h.plus = h.add = function (e) {
	...
	if (((e = new d(e)), !this.d || !e.d))
		return (!this.s || !e.s ? (e = new d(NaN)) : this.d || (e = new d(e.d || this.s === e.s ? this : NaN)), e);
...
var k = (() => {
	...
	return (t, r, s, o, u, c) => {
		...
		if (!O || !O[0] || !S || !S[0])
			return new ee(
				!t.s || !r.s || (O ? S && O[0] == S[0] : !S) ? NaN : (O && O[0] == 0) || !S ? he * 0 : he / 0,
			);
		for (
...
function Ge(e) {
	...
	function r(s) {
		...
		if (c === "bigint") return (s < 0 ? ((s = -s), (this.s = -1)) : (this.s = 1), re(this, s.toString()));
		throw Error($ + s);
	}
	if (
		((r.prototype = h),
