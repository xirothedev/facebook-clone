...
import { Bell, Gamepad2, House, Menu, MessageCircleMore, TvMinimalPlay, UsersRound } from "lucide-react";
...
export default function Header() {
	...
	return (
		<header className="fixed top-0 right-0 left-0 z-99 flex justify-between bg-white shadow-md">
			<div data-type="left" className="relative flex items-center gap-3 px-4 py-2">
				<Image
			...
			<div data-type="right" className="flex gap-1.5 px-4 py-2">
				<Tooltip>
					<TooltipTrigger asChild>
						<button type="button" className="flex size-10 rounded-full bg-(--primary-background)">
